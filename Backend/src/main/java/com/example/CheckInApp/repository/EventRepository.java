...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    List<Event> findByStatusAndLocationInAndRegistrationEndDateGreaterThanEqualOrderByStartDateTimeDesc(
            EventStatus status, List<EventLocation> locations, LocalDate today);
